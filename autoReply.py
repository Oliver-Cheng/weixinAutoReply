    ...
    # elif not msg['FromUserName'] == myUserName:    
        ...
        if auto_reply == True:
            ...
            if robort_reply == True and msg['FromUserName'] in peer_list:
                ...
                cont = requests.get('http://www.tuling123.com/openapi/api?key=7ef794901f1c456a939ba398efafa844&info=%s' % msg['Content']).content
                m = json.loads(cont)
